...
u = matrix([[0.], [0.]]) # external motion (ignore this)
...
R = matrix([[0.1]]) # measurement uncertainty
I = matrix([[1., 0.], [0., 1.]]) # identity matrix

for n in range(len(measurements)):

    [x,P, K]=update(x, P, measurements[n])
    [x,P]=prediction(x, P)

#we first print the measurement update and then the prediction
print(x, P, K) #result: x (final state position and velocity), P (final uncertainty)
