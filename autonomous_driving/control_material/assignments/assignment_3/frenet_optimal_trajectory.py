...
sim_speed = 25.0 # simulation speed [m/s]

SIM_LOOP = 500

# Parameter
MAX_SPEED = sim_speed # maximum speed [m/s]
MAX_ACCEL = sim_speed  # maximum acceleration [m/ss]
...
TARGET_SPEED = sim_speed  # target speed [m/s]
