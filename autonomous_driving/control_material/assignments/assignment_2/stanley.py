...
class StanleyController:
    ...
    def compute_steering_angle(self, current_pose, target_pose, speed):
        ...
        delta = 1.2 * heading_error + 15 * cross_track_correction
        
        # 15 perche è una buona via di mezzo per bilanciare sia il lateral error che il rapporto tra la forza frontale e lo slip angle
